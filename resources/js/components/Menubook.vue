<template>
  <front-layout title="Menu">
    <div class="max-w-5xl mx-auto min-h-screen">
      <img
        srcset="
          /images/menu/menu-v1-01-1x.jpg 1x,
          /images/menu/menu-v1-01-2x.jpg 2x
        "
        src="/images/menu/menu-v1-01-1x.jpg"
      />
      <img
        srcset="
          /images/menu/menu-v1-02-1x.jpg 1x,
          /images/menu/menu-v1-02-2x.jpg 2x
        "
      ...
      <img
        ...
        "
        src="/images/menu/menu-v1-10-1x.jpg"
      />
    </div>
  </front-layout>
</template>
